...
# https://github.com/philtabor/Youtube-Code-Repository/blob/master/ReinforcementLearning/DeepQLearning/simple_dqn_tf2.py
# python "F:\simple_dqn_tf2.py"
...
def my_dqn(lr, n_actions, input_dims, fc1_dims, fc2_dims):
    rows,cols=6,7
    inputs = tf.keras.Input(shape=(6,7))
...
class Agent():
    def __init__(self, lr, gamma, n_actions, epsilon, batch_size,
                ...
                mem_size=1000000, fname='F:\modelckpt\dqn_model.h5'):
